...
main( int argc, char *argv[ ] )
{
    ...
    cudaMalloc( (void **) &dholebxs, sizeof(hholebxs) );
    cudaMalloc( (void **) &dholebys, sizeof(hholebys) );
    cudaMalloc( (void **) &dholebrs, sizeof(hholebrs) );

    cudaMalloc( (void **) &dholecxs, sizeof(hholecxs) );
    cudaMalloc( (void **) &dholecys, sizeof(hholecys) );
